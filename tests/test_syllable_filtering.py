...
def test_exact_syllables():
    ...
    entry_2syl = {"word": "table", "syllables": 2}
    entry_3syl = {"word": "dictionary", "syllables": 4}
    entry_none = {"word": "unknown", "syllables": None}
...
def test_min_syllables():
    ...
    entry_1syl = {"word": "cat", "syllables": 1}
    entry_2syl = {"word": "table", "syllables": 2}
    entry_4syl = {"word": "dictionary", "syllables": 4}
    entry_none = {"word": "unknown", "syllables": None}
...
def test_range_syllables():
    ...
    entry_1syl = {"word": "cat", "syllables": 1}
    entry_2syl = {"word": "table", "syllables": 2}
    entry_3syl = {"word": "elephant", "syllables": 3}
    entry_4syl = {"word": "dictionary", "syllables": 4}
...
def test_require_syllables():
    ...
    entry_with = {"word": "table", "syllables": 2}
    entry_without = {"word": "unknown", "syllables": None}
...
def test_children_word_game_use_case():
    ...
    assert filtered[0]["word"] == "table"
    assert filtered[1]["word"] == "button"
...
def test_poetry_meter_use_case():
    ...
    assert len(filtered) == 2
    assert filtered[0]["word"] == "elephant"
    assert filtered[1]["word"] == "dictionary"
...
def test_simple_words_use_case():
    ...
    words = [
        ...
        {"word": "elephant", "syllables": 3},
        {"word": "dictionary", "syllables": 4},
        {"word": "simple", "syllables": None},  # No data, but not filtered if no require
    ]
    ...
    assert filtered[0]["word"] == "cat"
    assert filtered[1]["word"] == "table"
    assert filtered[2]["word"] == "elephant"
