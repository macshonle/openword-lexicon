...
def generate_index(language: str = 'en'):
    ...
    index += "- Normalized format with separate lexemes and senses files\n"
    index += "- Word-level properties in `en-lexemes-enriched.jsonl`\n"
    index += "- Sense-level properties in `en-senses.jsonl`\n"
    index += "- Flat directory structure with language-prefixed filenames\n"
